...
The description is shorter than the summary.
  ...
  s.homepage         = 'https://github.com/pro648/BlinkLabel'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'pro648' => 'example@example.com' }
  s.source           = { :git => 'https://github.com/pro648/BlinkLabel.git', :tag => s.version.to_s }
